...
import {AlumnoCreateRequest} from '@/lib/estructura/alumno/application/util/request/AlumnoCreateRequest';
import {AlumnoUpdateRequest} from '@/lib/estructura/alumno/application/util/request/AlumnoUpdateRequest';
...
function AlumnoFormCompBase(props: PropsAlumnoFormComp,ref:any): JSX.Element {	
	...
	*/
	...
	const nuevoDatos = async () => {
		...
		const form_json: AlumnoCreateRequest = {
...
let AlumnoFormComp = forwardRef(AlumnoFormCompBase);

export {AlumnoFormComp,AlumnoFormCompBase};
