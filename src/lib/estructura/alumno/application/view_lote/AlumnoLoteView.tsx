...
import {AlumnoReturnView} from '@/lib/estructura/alumno/application/util/dto/AlumnoReturnView';


import {AlumnoParamCreate} from '@/lib/estructura/alumno/application/util/type/AlumnoParamCreate';
import {AlumnoParamUpdate} from '@/lib/estructura/alumno/application/util/type/AlumnoParamUpdate';
