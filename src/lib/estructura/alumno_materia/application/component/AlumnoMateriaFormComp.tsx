...
import {AlumnoMateriaFKReturnView} from '@/lib/estructura/alumno_materia/application/util/return/AlumnoMateriaFKReturnView';

import {AlumnoMateriaCreateRequest} from '@/lib/estructura/alumno_materia/application/util/request/AlumnoMateriaCreateRequest';
import {AlumnoMateriaUpdateRequest} from '@/lib/estructura/alumno_materia/application/util/request/AlumnoMateriaUpdateRequest';
...
type PropsAlumnoMateriaFormComp = {
	module: string,
	controller: string,
...
function AlumnoMateriaFormCompBase(props: PropsAlumnoMateriaFormComp,ref:any): JSX.Element {	
	...
	*/
	...
	const nuevoDatos = async () => {
		...
		const form_json: AlumnoMateriaCreateRequest = {
...
let AlumnoMateriaFormComp = forwardRef(AlumnoMateriaFormCompBase);

export {AlumnoMateriaFormComp,AlumnoMateriaFormCompBase};
