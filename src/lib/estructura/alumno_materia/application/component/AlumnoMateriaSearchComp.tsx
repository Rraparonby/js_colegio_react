...
type PropsAlumnoMateriaSearchComp = {
	module: string,
	controller: string,
...
function AlumnoMateriaSearchCompBase(props: PropsAlumnoMateriaSearchComp,ref:any): JSX.Element {
	/*
	props: {
		//------------------ ACCIONES -------------------
		module:String,
...
let AlumnoMateriaSearchComp = forwardRef(AlumnoMateriaSearchCompBase);

export {AlumnoMateriaSearchCompBase,AlumnoMateriaSearchComp};
