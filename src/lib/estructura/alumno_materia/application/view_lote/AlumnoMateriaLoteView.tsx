...
import {AlumnoMateriaReturnView} from '@/lib/estructura/alumno_materia/application/util/dto/AlumnoMateriaReturnView';

import {AlumnoMateriaFKReturnView} from '@/lib/estructura/alumno_materia/application/util/dto/AlumnoMateriaFKReturnView';

import {AlumnoMateriaParamCreate} from '@/lib/estructura/alumno_materia/application/util/type/AlumnoMateriaParamCreate';
import {AlumnoMateriaParamUpdate} from '@/lib/estructura/alumno_materia/application/util/type/AlumnoMateriaParamUpdate';
