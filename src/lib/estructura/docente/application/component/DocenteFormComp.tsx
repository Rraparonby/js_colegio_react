...
import {DocenteCreateRequest} from '@/lib/estructura/docente/application/util/request/DocenteCreateRequest';
import {DocenteUpdateRequest} from '@/lib/estructura/docente/application/util/request/DocenteUpdateRequest';
...
function DocenteFormCompBase(props: PropsDocenteFormComp,ref:any): JSX.Element {	
	...
	*/
	...
	const nuevoDatos = async () => {
		...
		const form_json: DocenteCreateRequest = {
...
let DocenteFormComp = forwardRef(DocenteFormCompBase);

export {DocenteFormComp,DocenteFormCompBase};
