...
import {DocenteReturnView} from '@/lib/estructura/docente/application/util/dto/DocenteReturnView';


import {DocenteParamCreate} from '@/lib/estructura/docente/application/util/type/DocenteParamCreate';
import {DocenteParamUpdate} from '@/lib/estructura/docente/application/util/type/DocenteParamUpdate';
