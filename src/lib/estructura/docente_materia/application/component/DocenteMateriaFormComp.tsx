...
import {DocenteMateriaFKReturnView} from '@/lib/estructura/docente_materia/application/util/return/DocenteMateriaFKReturnView';

import {DocenteMateriaCreateRequest} from '@/lib/estructura/docente_materia/application/util/request/DocenteMateriaCreateRequest';
import {DocenteMateriaUpdateRequest} from '@/lib/estructura/docente_materia/application/util/request/DocenteMateriaUpdateRequest';
...
type PropsDocenteMateriaFormComp = {
	module: string,
	controller: string,
...
function DocenteMateriaFormCompBase(props: PropsDocenteMateriaFormComp,ref:any): JSX.Element {	
	...
	*/
	...
	const nuevoDatos = async () => {
		...
		const form_json: DocenteMateriaCreateRequest = {
...
let DocenteMateriaFormComp = forwardRef(DocenteMateriaFormCompBase);

export {DocenteMateriaFormComp,DocenteMateriaFormCompBase};
