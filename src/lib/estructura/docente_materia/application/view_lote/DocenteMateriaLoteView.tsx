...
import {DocenteMateriaReturnView} from '@/lib/estructura/docente_materia/application/util/dto/DocenteMateriaReturnView';

import {DocenteMateriaFKReturnView} from '@/lib/estructura/docente_materia/application/util/dto/DocenteMateriaFKReturnView';

import {DocenteMateriaParamCreate} from '@/lib/estructura/docente_materia/application/util/type/DocenteMateriaParamCreate';
import {DocenteMateriaParamUpdate} from '@/lib/estructura/docente_materia/application/util/type/DocenteMateriaParamUpdate';
