...
import {MateriaReturnView} from '@/lib/estructura/materia/application/util/dto/MateriaReturnView';


import {MateriaParamCreate} from '@/lib/estructura/materia/application/util/type/MateriaParamCreate';
import {MateriaParamUpdate} from '@/lib/estructura/materia/application/util/type/MateriaParamUpdate';
