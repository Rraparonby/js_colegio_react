...
import {ContratoFKReturnView} from '@/lib/financiero/contrato/application/util/return/ContratoFKReturnView';

import {ContratoCreateRequest} from '@/lib/financiero/contrato/application/util/request/ContratoCreateRequest';
import {ContratoUpdateRequest} from '@/lib/financiero/contrato/application/util/request/ContratoUpdateRequest';
...
function ContratoFormCompBase(props: PropsContratoFormComp,ref:any): JSX.Element {	
	...
	*/
	...
	const nuevoDatos = async () => {
		...
		const form_json: ContratoCreateRequest = {
...
let ContratoFormComp = forwardRef(ContratoFormCompBase);

export {ContratoFormComp,ContratoFormCompBase};
