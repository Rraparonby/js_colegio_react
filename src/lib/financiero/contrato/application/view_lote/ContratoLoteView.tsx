...
import {ContratoReturnView} from '@/lib/financiero/contrato/application/util/dto/ContratoReturnView';

import {ContratoFKReturnView} from '@/lib/financiero/contrato/application/util/dto/ContratoFKReturnView';

import {ContratoParamCreate} from '@/lib/financiero/contrato/application/util/type/ContratoParamCreate';
import {ContratoParamUpdate} from '@/lib/financiero/contrato/application/util/type/ContratoParamUpdate';
