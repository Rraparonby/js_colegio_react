...
import {PensionFKReturnView} from '@/lib/financiero/pension/application/util/return/PensionFKReturnView';

import {PensionCreateRequest} from '@/lib/financiero/pension/application/util/request/PensionCreateRequest';
import {PensionUpdateRequest} from '@/lib/financiero/pension/application/util/request/PensionUpdateRequest';
...
function PensionFormCompBase(props: PropsPensionFormComp,ref:any): JSX.Element {	
	...
	*/
	...
	const nuevoDatos = async () => {
		...
		const form_json: PensionCreateRequest = {
...
let PensionFormComp = forwardRef(PensionFormCompBase);

export {PensionFormComp,PensionFormCompBase};
