...
function PensionSearchCompBase(props: PropsPensionSearchComp,ref:any): JSX.Element {
	/*
	props: {
		//------------------ ACCIONES -------------------
		module:String,
	...
	*/
	...
	//------------------ GENERAL --------------------
	//const [title,setTitle] = useState("Buscar Pension");
	...
	const updated_pensions = () => {
		props.updateDatosView(pensions);
	};
	
	useEffect(updated_pensions,[pensions]);
	...
	<div id="div_pension_form_buscar" className="div_buscar_general">
		...
		<div id="div_FK_Idalumno" className="tab_item">
			<form id="pension_FK_Idalumno_form_buscar" className="form_buscar_general">
...
let PensionSearchComp = forwardRef(PensionSearchCompBase);

export {PensionSearchCompBase,PensionSearchComp};
