...
import {SueldoFKReturnView} from '@/lib/financiero/sueldo/application/util/return/SueldoFKReturnView';

import {SueldoCreateRequest} from '@/lib/financiero/sueldo/application/util/request/SueldoCreateRequest';
import {SueldoUpdateRequest} from '@/lib/financiero/sueldo/application/util/request/SueldoUpdateRequest';
...
function SueldoFormCompBase(props: PropsSueldoFormComp,ref:any): JSX.Element {	
	...
	*/
	...
	const nuevoDatos = async () => {
		...
		const form_json: SueldoCreateRequest = {
...
let SueldoFormComp = forwardRef(SueldoFormCompBase);

export {SueldoFormComp,SueldoFormCompBase};
