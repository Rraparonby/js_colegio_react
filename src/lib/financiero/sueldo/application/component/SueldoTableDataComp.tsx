...
import {SueldoTableRowDataComp} from '@/lib/financiero/sueldo/application/component/SueldoTableRowDataComp';
...
function SueldoTableDataComp(props: PropsSueldoTableDataComp): JSX.Element {	
	...
	*/
	...
	const handleAction_ClickTableRowTableView = async (sueldo1:Sueldo) => {	
		//setTipo_accion(Constantes.SELECCIONAR);		
		//abrir_modal_form_general();
		
		props.handleAction_ClickTableRowView(sueldo1);
		...
		<table id="sueldo_tabla_general" className="table_general">
			...
			<tbody>
				{props.sueldos.map((sueldo1:Sueldo) => {
                    return [
						<SueldoTableRowDataComp 
							key={sueldo1.id}
							module={props.module}
							controller={props.controller}
							style_id_column={style_id_column}
							sueldo1={sueldo1} 
							handleAction_ClickTableRowTableView={(e) => handleAction_ClickTableRowTableView(sueldo1)} >
