...
import {SueldoReturnView} from '@/lib/financiero/sueldo/application/util/dto/SueldoReturnView';

import {SueldoFKReturnView} from '@/lib/financiero/sueldo/application/util/dto/SueldoFKReturnView';

import {SueldoParamCreate} from '@/lib/financiero/sueldo/application/util/type/SueldoParamCreate';
import {SueldoParamUpdate} from '@/lib/financiero/sueldo/application/util/type/SueldoParamUpdate';
