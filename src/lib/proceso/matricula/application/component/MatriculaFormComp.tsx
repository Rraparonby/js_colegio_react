...
import {MatriculaFKReturnView} from '@/lib/proceso/matricula/application/util/return/MatriculaFKReturnView';

import {MatriculaCreateRequest} from '@/lib/proceso/matricula/application/util/request/MatriculaCreateRequest';
import {MatriculaUpdateRequest} from '@/lib/proceso/matricula/application/util/request/MatriculaUpdateRequest';
...
function MatriculaFormCompBase(props: PropsMatriculaFormComp,ref:any): JSX.Element {	
	...
	*/
	...
	const nuevoDatos = async () => {
		...
		const form_json: MatriculaCreateRequest = {
...
let MatriculaFormComp = forwardRef(MatriculaFormCompBase);

export {MatriculaFormComp,MatriculaFormCompBase};
