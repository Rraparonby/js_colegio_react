...
function MatriculaSearchCompBase(props: PropsMatriculaSearchComp,ref:any): JSX.Element {
	/*
	props: {
		//------------------ ACCIONES -------------------
		module:String,
...
let MatriculaSearchComp = forwardRef(MatriculaSearchCompBase);

export {MatriculaSearchCompBase,MatriculaSearchComp};
