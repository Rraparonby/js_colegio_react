...
import {MatriculaReturnView} from '@/lib/proceso/matricula/application/util/dto/MatriculaReturnView';

import {MatriculaFKReturnView} from '@/lib/proceso/matricula/application/util/dto/MatriculaFKReturnView';

import {MatriculaParamCreate} from '@/lib/proceso/matricula/application/util/type/MatriculaParamCreate';
import {MatriculaParamUpdate} from '@/lib/proceso/matricula/application/util/type/MatriculaParamUpdate';
