...
import {NotaFKReturnView} from '@/lib/proceso/nota/application/util/return/NotaFKReturnView';

import {NotaCreateRequest} from '@/lib/proceso/nota/application/util/request/NotaCreateRequest';
import {NotaUpdateRequest} from '@/lib/proceso/nota/application/util/request/NotaUpdateRequest';
...
function NotaFormCompBase(props: PropsNotaFormComp,ref:any): JSX.Element {	
	...
	*/
	...
	const nuevoDatos = async () => {
		...
		const form_json: NotaCreateRequest = {
...
let NotaFormComp = forwardRef(NotaFormCompBase);

export {NotaFormComp,NotaFormCompBase};
