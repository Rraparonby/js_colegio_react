...
function NotaSearchCompBase(props: PropsNotaSearchComp,ref:any): JSX.Element {
	/*
	props: {
		//------------------ ACCIONES -------------------
		module:String,
...
let NotaSearchComp = forwardRef(NotaSearchCompBase);

export {NotaSearchCompBase,NotaSearchComp};
