...
import {NotaReturnView} from '@/lib/proceso/nota/application/util/dto/NotaReturnView';

import {NotaFKReturnView} from '@/lib/proceso/nota/application/util/dto/NotaFKReturnView';

import {NotaParamCreate} from '@/lib/proceso/nota/application/util/type/NotaParamCreate';
import {NotaParamUpdate} from '@/lib/proceso/nota/application/util/type/NotaParamUpdate';
